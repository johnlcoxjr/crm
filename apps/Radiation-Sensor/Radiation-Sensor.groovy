...
metadata {
	...
	definition (name: "Radiation Sensor", version: "3.0.1", namespace: "johnlcox", author: "john.l.cox@live.com",importUrl: "https://raw.githubusercontent.com/johnlcoxjr/Hubitat/master/Drivers/Radiation-Sensor.groovy") {
        capability "Sensor"
    ...
    main(["radiation"])
    details(["radiation","msg","version","backlight"])
}
